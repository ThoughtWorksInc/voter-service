...
The project's source code is continuously built and tested on every code check-in to GitHub. If all unit tests pass, the resulting Spring Boot JAR is stored in the [voter-service-artifacts](https://github.com/ThoughtWorksInc/voter-service) GitHub repository.
